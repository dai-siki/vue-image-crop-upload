export default {
	...
	fa: {
		hint: 'لطفا کلیک کنید یا تصاویر انتخابی را روی این کادر درگ نمایید',
		loading: 'در حال بارگذاری...',
		noSupported: 'مرورگر شما این بخش را پشتیبانی نمی کند, لطفا از سایر مرورگرها و یا اینترنت اکسپلورر ۱۰ به بالا استفاده نمایید ',
		success: 'با موفقیت بارگذاری شد',
		fail: 'بارگذاری با خطا روبرو شد',
		preview: 'نمایش',
		btn: {
			off: 'لغو',
			close: 'بستن',
		...
		error: {
			onlyImg: 'فقط تصویر',
			outOfSize: 'پسوند های مورد قبول:',
			lowestPx: 'تصویر انتخابی بزرگ تر از انتظار است. حداکثر سایز مورد قبول:'
		}
	}
};
