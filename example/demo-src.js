...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    computed: {
	        ...
	        previewrStyle: function previewrStyle() {
	            var width = this.width,
	                height = this.height,
	                ratio = this.ratio,
